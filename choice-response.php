  ...
  <div id="wrapper">
    ...
    <form method="post" action="">
      ...
      <h3 class="section-header">Student Information</h3>
       ...
       <fieldset>
         ...
         <div class="form-row">
           ...
           <input id="unit" name="unit"   required><br />
         </div>
         <div class="form-row">
      ...
      <div class="input-group">
        <label for="terms">I accept the terms and conditions for signing up to this admission system, and hereby confirm I have read the privacy policy.</label>
      </div>
